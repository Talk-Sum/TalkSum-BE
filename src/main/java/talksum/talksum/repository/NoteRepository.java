...
public interface NoteRepository extends JpaRepository<Note, Long> {
    ...
    Long countByAuthorAndTitleContainingAndIsTrashFalse(Member author, String keyword);
    Page<Note> findByAuthorAndIsTrashTrue(Member author,Pageable pageable);
    Long countByAuthorAndIsTrashTrue(Member author);

    Page<Note> findByAuthorAndIsTrashFalse(Member author, Pageable pageable);

    Long countByAuthorAndIsTrashFalse(Member author);

    Page<Note> findByAuthorAndBookMarkTrueAndIsTrashFalse(Member author, Pageable pageable);

    Long countByAuthorAndBookMarkTrueAndIsTrashFalse(Member author);
    ...
    void deleteNotesByAuthorAndIsTrashTrue(Member member);
